            ...
            <div class="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Start your journey with <span class="text-blue-600">Gung Dika Ebs</span></h1>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
                    <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                        <div
                            ...
                            <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 12, SEP
                                ,
                                2022
                            </p>
                        </div>
