                                ...
                                <li class="mb-4" wire:key="{{ $category->id }}">
                                    <label for="{{ $category->slug }}" class="flex items-center dark:text-gray-400 ">
                                        <input type="checkbox" id="{{ $category->slug }}"
                                            wire:model.model.live="selected_categories" value="{{ $category->id }}"
                                            class="w-4 h-4 mr-2">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            ...
                            <input type="range" wire:model.live='price_range'
                                ...
                                max="100000000" value="100000" step="100000">
                            <div class="flex justify-between ">
                                <span class="inline-block text-lg font-bold text-blue-400 ">
                                    {{ 'Rp ' . number_format('1000', 0, ',', '.') }}</span>
                                <span class="inline-block text-lg font-bold text-blue-400 ">
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire::key="{{ $product->id }}">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span
                                                class="text-green-600 dark:text-green-600">{{ 'Rp ' . number_format($product->price, 0, ',', '.') }}</span>
                                        </p>
                                    </div>
